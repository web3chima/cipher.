export function Footer({ logoSrc = '/logo.png' }) {
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <img src={logoSrc} alt="Cipher" className="h-8 mb-4 brightness-0 invert" />
            <p className="text-sm">
              Privacy and security stack for environments with robots.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm">
            &copy; {currentYear} Cipher. All rights reserved.
          </p>
